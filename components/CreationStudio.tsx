  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center p-4 relative z-10">
      ...
      <div className="text-center mb-10 animate-fade-in-up">
        <h1 className="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-indigo-400 to-purple-400 tracking-tighter uppercase">
          Lumina
        </h1>
        <p className="text-xl text-slate-400 mt-2 font-light tracking-wide uppercase">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <Textarea
              ...
              className="bg-slate-900/50 border-slate-700 text-lg h-32 focus:ring-sky-500/50"
            />
          </div>
          ...
          <div className="relative group">
            ...
            <label className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-slate-700 rounded-lg cursor-pointer hover:bg-slate-800/50 hover:border-sky-500 transition-all duration-300">
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                {fileName ? (
                  <p className="text-sm text-sky-400 font-semibold">{fileName}</p>
                ) : (
                  <>
          ...
          <Button 
            ...
            className="w-full h-14 text-lg bg-gradient-to-r from-sky-600 to-indigo-600 hover:from-sky-500 hover:to-indigo-500 shadow-[0_0_20px_rgba(79,70,229,0.4)] border border-white/10"
          >
            {isLoading ? (
